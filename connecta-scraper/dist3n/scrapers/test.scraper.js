 ...
 */
class TestScraper extends base_scraper_1.BaseScraper {
    constructor() {
        super(...arguments);
        this.name = "test-platform";
    }
    async scrape() {
        logger_1.logger.info("🧪 Running test scraper with mock data...");
        ...
        logger_1.logger.info(`✅ Generated ${mockGigs.length} test jobs`);
        return mockGigs;
    }
}
