      ...
      <main className="flex-1 p-4 md:p-8 overflow-x-auto">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-wrap justify-between gap-4 items-center mb-6">
            <p className="text-gray-900 dark:text-white text-2xl md:text-4xl font-black leading-tight tracking-[-0.033em]">Job Postings Management</p>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="flex w-full flex-1 items-stretch rounded-lg h-12">
                  ...
                  <input
                    ...
                    placeholder="Search by job title, client..."
                  />
                </div>
              </div>
              {/* Chips */}
              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 min-w-[640px]">
                <thead className="text-xs text-gray-700 dark:text-gray-300 uppercase bg-gray-50 dark:bg-gray-900/50">
                  <tr>
                    ...
                    <th scope="col" className="px-6 py-3 font-semibold">Date Posted</th>
                    <th scope="col" className="px-6 py-3 font-semibold">Budget</th>
                    <th scope="col" className="px-6 py-3 font-semibold">Status</th>
                    <th scope="col" className="px-6 py-3 font-semibold">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-white dark:bg-[#181210] border-b dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    <td className="p-4 w-4"><input type="checkbox" className="form-checkbox h-4 w-4 rounded text-primary bg-gray-100 border-gray-300 focus:ring-primary dark:focus:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" /></td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">Senior UI/UX Designer</td>
                    <td className="px-6 py-4">Innovate Inc.</td>
                    <td className="px-6 py-4">2023-10-26</td>
                    <td className="px-6 py-4">$8,000</td>
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">Open</span>
                    </td>
                    <td className="px-6 py-4"><button className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"><Icon name="more_horiz" /></button></td>
                  </tr>
                  <tr className="bg-white dark:bg-[#181210] border-b dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    <td className="p-4 w-4"><input type="checkbox" className="form-checkbox h-4 w-4 rounded text-primary bg-gray-100 border-gray-300 focus:ring-primary dark:focus:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" /></td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">Backend Developer (Python)</td>
                    <td className="px-6 py-4">Data Solutions Ltd.</td>
                    <td className="px-6 py-4">2023-10-24</td>
                    <td className="px-6 py-4">Hourly</td>
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300">In Progress</span>
                    </td>
                    <td className="px-6 py-4"><button className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"><Icon name="more_horiz" /></button></td>
                  </tr>
                  <tr className="bg-white dark:bg-[#181210] border-b dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    <td className="p-4 w-4"><input type="checkbox" className="form-checkbox h-4 w-4 rounded text-primary bg-gray-100 border-gray-300 focus:ring-primary dark:focus:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" /></td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">Content Writer for Blog</td>
                    <td className="px-6 py-4">Marketing Gurus</td>
                    <td className="px-6 py-4">2023-10-22</td>
                    <td className="px-6 py-4">$1,500</td>
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-300">Closed</span>
                    </td>
                    <td className="px-6 py-4"><button className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"><Icon name="more_horiz" /></button></td>
                  </tr>
                  <tr className="bg-white dark:bg-[#181210] border-b dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    <td className="p-4 w-4"><input type="checkbox" className="form-checkbox h-4 w-4 rounded text-primary bg-gray-100 border-gray-300 focus:ring-primary dark:focus:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" /></td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">Brand Identity & Logo Design</td>
                    <td className="px-6 py-4">StartupLaunch</td>
                    <td className="px-6 py-4">2023-10-21</td>
                    <td className="px-6 py-4">$3,000</td>
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300">Deleted</span>
                    </td>
                    <td className="px-6 py-4"><button className="text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-200"><Icon name="more_horiz" /></button></td>
                  </tr>
                  <tr className="bg-white dark:bg-[#181210] hover:bg-gray-50 dark:hover:bg-gray-900/50">
                    <td className="p-4 w-4"><input type="checkbox" className="form-checkbox h-4 w-4 rounded text-primary bg-gray-100 border-gray-300 focus:ring-primary dark:focus:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600" /></td>
                    <td className="px-6 py-4 font-medium text-gray-900 dark:text-white whitespace-nowrap">Mobile App QA Testing</td>
                    <td className="px-6 py-4">Techify Apps</td>
