              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-4">
                <div className="flex-1 relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
                <select
                  value={filterType}
            ...
            <div className="overflow-x-auto">
              {loading ? (
                ...
                <div className="text-center py-20">
                  <Icon name="person_off" size={64} className="mx-auto text-slate-400 mb-4 opacity-50" />
            ...
            <div className="relative bg-white dark:bg-slate-800 rounded-xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden flex flex-col">
              ...
              <div className="flex-1 overflow-y-auto p-6">
                {loadingDetails ? (
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-br from-primary/10 to-amber-500/10 dark:from-primary/20 dark:to-amber-500/20 rounded-xl p-6">
                      <div className="flex items-start gap-6">
                        <div
                          className="h-24 w-24 rounded-full bg-gradient-to-br from-primary to-amber-500 flex items-center justify-center text-white font-bold text-3xl flex-shrink-0"
                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div>
                              ...
                              <p className="text-slate-900 dark:text-white font-medium capitalize">{userDetails.user.userType}</p>
                            </div>
                            <div>
                              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Joined</p>
                              <p className="text-slate-900 dark:text-white font-medium">{formatDate(userDetails.user.createdAt)}</p>
                            </div>
                            <div>
                              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Rating</p>
                              <p className="text-slate-900 dark:text-white font-medium">
                                {userDetails.user.rating ? `${userDetails.user.rating}/5 ⭐` : 'N/A'}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Phone</p>
                              <p className="text-slate-900 dark:text-white font-medium">{userDetails.user.phone || 'N/A'}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-2xl font-bold text-blue-600 dark:text-blue-400">{userDetails.stats?.totalProjects || 0}</p>
                      ...
                      <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-2xl font-bold text-green-600 dark:text-green-400">{userDetails.stats?.totalPayments || 0}</p>
                            <p className="text-xs text-slate-600 dark:text-slate-400">Payments</p>
                          </div>
                        </div>
                      </div>
                      <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-2xl font-bold text-purple-600 dark:text-purple-400">{userDetails.stats?.totalProposals || 0}</p>
                            <p className="text-xs text-slate-600 dark:text-slate-400">Proposals</p>
                          </div>
                        </div>
                      </div>
                      <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-lg font-bold text-amber-600 dark:text-amber-400">{formatCurrency(userDetails.stats?.totalEarnings || 0)}</p>
                    ...
                    {userDetails.profile && (
                      <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          <div>
                            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Bio</p>
                            <p className="text-slate-900 dark:text-white">{userDetails.profile.bio || 'No bio provided'}</p>
                          </div>
                          <div>
                            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Skills</p>
                            <p className="text-slate-900 dark:text-white">{userDetails.profile.skills?.join(', ') || 'No skills listed'}</p>
                          </div>
                          <div>
                            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Location</p>
                            <p className="text-slate-900 dark:text-white">{userDetails.profile.location || 'Not specified'}</p>
                          </div>
                          <div>
                            <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase mb-1">Hourly Rate</p>
                            <p className="text-slate-900 dark:text-white">{userDetails.profile.hourlyRate ? formatCurrency(userDetails.profile.hourlyRate) : 'Not set'}</p>
                          </div>
                        </div>
                      </div>
                    )}
                      ...
                      <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="space-y-3">
                          {userDetails.projects.slice(0, 5).map((project: any) => (
                            <div key={project._id} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                              <div className="flex-1">
                      ...
                      <div className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700">
                        ...
                        <div className="space-y-3">
                          {userDetails.payments.slice(0, 5).map((payment: any) => (
                            <div key={payment._id} className="flex items-center justify-between p-3 bg-slate-50 dark:bg-slate-800 rounded-lg">
                              <div className="flex-1">
                                <p className="font-semibold text-slate-900 dark:text-white">{payment.description || 'Payment'}</p>
              ...
              {userDetails && (
                <div className="flex items-center justify-between p-6 border-t border-slate-200 dark:border-slate-700">
                  <div className="flex gap-3">
                    {userDetails.user.isActive === false ? (
                      <button
                        ...
                        className="px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium inline-flex items-center gap-2"
                      >
                    ...
                    <button
                      ...
                      className="px-4 py-2.5 bg-slate-700 text-white rounded-lg hover:bg-slate-800 transition-colors font-medium inline-flex items-center gap-2"
                    >
                  ...
                  <button
                    onClick={() => setShowDetailModal(false)}
                    className="px-4 py-2.5 bg-slate-100 dark:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors font-medium"
                  >
                    Close
                  </button>
                </div>
