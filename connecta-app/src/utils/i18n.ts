...
const translations = {
    en: {
        ...
        proposal_accepted_msg: 'Proposal accepted and project created. You can now start working.',
        proposal_accept_fail: 'Failed to accept proposal.',
        proposal_reject_fail: 'Failed to reject proposal.',
        job_details: 'Job Details',
        job_load_fail: 'Job not found or failed to load.',
        external: 'External',
        verified: 'Verified',
        type: 'Type',
        full_time: 'Full Time',
        ...
        ai_insights: 'Connecta AI Insights',
        why_fits_you: 'Why this fits you',
        your_skills_in: 'Your skills in',
        match_requirements: 'match 95% of the requirements.',
        key_phrases: 'Key Phrases to Include',
        ...
        setup_profile_sub: 'Set up your profile to start hiring',
        ...
        budget: 'Budget',
        no_posted_jobs: 'No posted jobs yet.',
        anonymous: 'Anonymous',
        ...
        default_user: 'User',
        daily_reward_title: 'Daily Spark Reward! ✨',
        daily_reward_msg: 'Your daily gift is ready. Claim your sparks now to keep the flame alive!',
        claiming: 'Claiming...',
        claim_sparks: 'Claim 10 Sparks',
        team_label: 'Team',
        ...
        login_desc: 'Continue where you left off and connect with the best talent.',
    },
    ha: {
        ...
        hourly: 'Na Sa\'a',
        freelancer_hired: 'An Dauki Dan Kwangila!',
        proposal_accepted_msg: 'An amince da tayin kuma an kirkiro aiki. Kuna iya fara aiki yanzu.',
        proposal_accept_fail: 'An kasa amincewa da tayin.',
        proposal_reject_fail: 'An kasa kin tayin.',
        job_details: 'Bayanan Aiki',
        job_load_fail: 'Ba a sami aiki ba ko an kasa daukowa.',
        external: 'Na Waje',
        verified: 'Tabbatacce',
        type: 'Nau\'i',
        ...
        remote: 'Daga Nesa',
        description: 'Bayani',
        read_more: 'Karanta Kari',
        skills_requirements: 'Kwarewa & Bukatu',
        ai_insights: 'Basirar Connecta AI',
        why_fits_you: 'Me yasa wannan ya dace da kai',
        your_skills_in: 'Kwarewarka a',
        match_requirements: 'sun dace da kashi 95% na bukatun.',
        key_phrases: 'Jumlolin da ya kamata a saka',
        about_client: 'Game da Abokin Ciniki',
        external_client: 'Abokin Ciniki na Waje',
        unknown_client: 'Abokin Ciniki da ba a sani ba',
        responsiveness: 'Saurin Amsawa',
        no_proposals: 'Babu tayi tukuna.',
        visit_job: 'Ziyarci Aiki',
        applied: 'An Nema',
        view_project: 'Duba Aiki',
        my_profile: 'Bayanin Martaba',
        job_preferences: 'Abubuwan da ake so a Aiki',
        contracts: 'Kwangiloli',
        settings: 'Saituna',
        help_support: 'Taimako & Tallafi',
        terms_conditions: 'Sharudda & Ka\'idoji',
        about_connecta: 'Game da Connecta',
        client: 'Abokin Ciniki',
        logout: 'Fita',
        version: 'Lamba',
        profile_title: "Bayanin Martabar {{name}}",
        member_since_year: 'Dan kungiya tun {{year}}',
        enter_comment: 'Don Allah saka tsokaci',
        review_submit_error: 'An kasa tura sharhi',
        profile_not_found: 'Ba a sami bayanin martaba ba',
        profile_load_error: 'An kasa dauko bayanan martaba',
        no_profile: 'Babu bayanin martaba tukuna',
        setup_profile_sub: 'Saita bayanin martabarka don fara daukar aiki',
        create_profile: 'Kirkiri Bayanin Martaba',
        jobs: 'Ayyuka',
        spend: 'Kudin da aka kashe',
        rating: 'Daraja',
        freelancer: 'Dan Kwangila',
        individual_client: 'Abokin Ciniki na Kashin Kai',
        no_location: 'Babu wuri',
        member_since: 'Dan kungiya tun',
        no_bio: 'Babu bayani tukuna.',
        edit_profile: 'Gyara Bayanin Martaba',
        invite_to_job: 'Gayyata zuwa Aiki',
        message: 'Sako',
        add_review: 'Kara Sharhi',
        trust_score: 'Darajar Amincewa',
        posted_jobs: 'Ayyukan da aka Bada',
        no_portfolio: 'Babu ayyuka a portfolio tukuna.',
        budget: 'Kasafin Kudi',
        no_posted_jobs: 'Babu ayyukan da aka bada tukuna.',
        anonymous: 'Ba a Sani ba',
        project_label: 'Aiki',
        untitled_project: 'Aikin da ba a sa suna ba',
        no_reviews: 'Babu sharhi tukuna.',
        your_comment: 'Tsokacinka',
        share_experience: 'Bada labarin kwarewarka...',
        submit_review: 'Tura Sharhi',
        active_projects: 'Ayyukan da Suke Kan Yi',
        payments_due: 'Kudin da za a biya',
        total_spent: 'Jimlar Kudin da aka kashe',
        projects: 'Ayyuka',
        payments: 'Biya',
        post_job: 'Bada Aiki',
        see_all: 'Duba Duka',
        recommended_for_you: 'Wadanda suka dace da kai',
        view_profile: 'Duba Bayaninsa',
        invite: 'Gayyata',
        no_recommendations: 'Babu wani shawarwari',
        complete_profile_btn: 'Cika Bayaninka',
        default_user: 'Mai amfani',
        daily_reward_title: 'Kyautar Tsini ta Kullum! ✨',
        daily_reward_msg: 'Kyautar ka ta kullum ta shirya. Karbi tsinin ka yanzu don ci gaba da wuta!',
        claiming: 'Ana Karba...',
        claim_sparks: 'Karbi Tsini 10',
        team_label: 'Kungiya',
        search_placeholder: 'Nemi ayyuka...',
        new_badge: 'SABO',
        confidential: 'Sirri',
        no_description: 'Babu bayani',
        apply: 'Nema',
        reviews: 'Sharhi',
        write_review: 'Rubuta Sharhi',
        review_submitted: 'An Tura Sharhi!',
        biometric_auth_failed: 'Tabbatar da yatsa ya gaza',
        login_failed: 'Shiga ya gaza',
        invalid_credentials: 'Bayanai ba daidai ba',
        enter_email: 'Don Allah saka adireshin imel dinka',
        enter_password: 'Don Allah saka kalmar sirrinka',
        login_biometric: 'Shiga da Yatsa',
        use_passcode: 'Yi amfani da Lambobi',
        login_desc: 'Ci gaba daga inda ka tsaya kuma ka hadu da kwararrun ma\'aikata.',
    }
};
