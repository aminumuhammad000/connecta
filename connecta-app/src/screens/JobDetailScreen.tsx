  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: c.background }}>
      ...
      <View style={[styles.appBar, { borderBottomColor: c.border }]}> 
        ...
        <TouchableOpacity style={styles.iconBtn} accessibilityRole="button" accessibilityLabel="Save">
          <MaterialIcons name="bookmark-border" size={22} color={c.text} />
        </TouchableOpacity>
      </View>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 24 + insets.bottom }}>
        <View style={{ paddingHorizontal: 16, paddingTop: 16 }}>
          ...
          <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 16, marginTop: 8 }}>
            <Text style={{ color: c.subtext, fontSize: 13 }}>Posted by WebFlow ★ 4.8</Text>
            <Text style={{ color: c.subtext, fontSize: 13 }}>Posted 2 hours ago</Text>
          </View>
          ...
          <View style={{ marginTop: 16 }}>
            ...
            <Text style={{ color: c.subtext, lineHeight: 20, fontSize: 14 }}>
              We are looking for a talented and experienced Senior UX/UI Designer to lead the design of our new flagship mobile application. You will be responsible for the entire design process, from user research and wireframing to creating high-fidelity mockups and interactive prototypes...
              <Text style={{ color: c.primary, fontWeight: '700' }}> Read More</Text>
            </Text>
          </View>
          ...
          <View style={{ marginTop: 16 }}>
            ...
            <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 8 }}>
              {['UX Design', 'UI Design', 'Figma', 'Prototyping', 'Mobile App Design'].map(s => (
                <Text key={s} style={[styles.skill, { color: c.primary, backgroundColor: c.isDark ? 'rgba(253,103,48,0.2)' : 'rgba(253,103,48,0.12)' }]}>{s}</Text>
              ))}
            </View>
          </View>
          ...
          <View style={{ marginTop: 16 }}>
            ...
            <View style={[styles.clientCard, { borderColor: c.border, backgroundColor: c.card }]}> 
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={{ color: c.subtext, fontSize: 12 }}>San Francisco, CA</Text>
                <Text style={{ color: c.subtext, fontSize: 11, marginTop: 4 }}>15 Jobs Posted • Member Since 2022</Text>
              </View>
...
const styles = StyleSheet.create({
  ...
  keyValue: { fontSize: 15, fontWeight: '700', marginTop: 2 },

  skill: { paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999, fontSize: 13, fontWeight: '700' },

  clientCard: { flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: StyleSheet.hairlineWidth, borderRadius: 12, padding: 12 },
  ...
  attachmentLabel: { flex: 1, fontSize: 14, fontWeight: '600' },
