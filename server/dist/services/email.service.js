 ...
 * Send OTP email to user
 */
export const sendOTPEmail = async (email, otp, userName, type = 'PASSWORD_RESET', language = 'en') => {
    try {
 ...
 */
export const sendWelcomeEmail = async (email, userName, language = 'en') => {
 ...
 * Send Gig Notification Email
 */
export const sendGigNotificationEmail = async (email, userName, jobTitle, jobLink, skills, language = 'en') => {
    try {
        const transporter = await getTransporter();
        if (!transporter)
            return { success: false, error: 'Transporter not available' };
 ...
 */
export const sendProfileReminderEmail = async (email, userName) => {
 ...
 */
export const sendWalletCreditedEmail = async (email, userName, amount, source) => {
 ...
 */
export const sendJobApprovedEmail = async (email, userName, jobTitle, amount) => {
 ...
 */
export const sendNewMessageEmail = async (email, userName, senderName, messagePreview, chatLink) => {
