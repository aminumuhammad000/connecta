...
export const getAllProjects = async (req, res) => {
    try {
        ...
        const transformedProjects = projects.map(project => ({
            ...
            clientName: project.clientName || (project.clientId ? `${project.clientId.firstName} ${project.clientId.lastName}` : 'Unknown'),
...
export const acceptProjectSubmission = async (req, res) => {
    try {
        ...
        project.activity.push({ date: new Date(), description: 'Project submission accepted and marked as completed.' });
        await project.save();
