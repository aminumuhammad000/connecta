 ...
 */
export const RELATED_TASKS_MAP = {
    // Profile Tools
 ...
 */
export function getRelatedTasks(toolName, context) {
 ...
 */
export function formatRelatedTasks(tasks) {
 ...
 */
export function getQuickActions(toolName) {
    const actionMap = {
        get_profile_details_tool: [
