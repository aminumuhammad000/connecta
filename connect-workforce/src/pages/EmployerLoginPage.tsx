...
export const EmployerLoginPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col lg:flex-row font-sans text-gray-900">
      {/* LEFT SIDE: Minimalist Employer Login Form */}
      <div className="flex-1 flex flex-col justify-between p-6 sm:p-10 lg:p-14 max-w-xl mx-auto lg:mx-0 w-full">
        ...
        <div className="my-auto py-6 space-y-6">
          ...
          <div className="text-center sm:text-left space-y-1">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-orange-50 border border-orange-100 text-primary font-extrabold text-xs mb-2">
              <Building2 className="w-3.5 h-3.5 text-primary" /> Employer Portal Access
            </div>
            <h1 className="text-3xl sm:text-4xl font-black text-gray-900 tracking-tight">
              Employer Sign In
            </h1>
            <p className="text-sm font-medium text-gray-500">Access workforce management, shift tracking, and payroll.</p>
          </div>

          {/* Login Form */}
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-gray-800 mb-1.5">Employer Work Email</label>
              <input
                type="email"
                required
                placeholder="musa@apexworkforce.com"
                value={email}
            ...
            >
              {submitting ? <Loader2 className="w-4 h-4 animate-spin" /> : <span>Access Employer Portal</span>}
            </button>
          </form>
        </div>
      ...
      <div className="hidden lg:flex flex-1 bg-[#09090b] text-white p-12 lg:p-16 flex-col justify-between relative overflow-hidden border-l border-gray-800">
        ...
        <div className="relative z-10 max-w-lg pt-12 space-y-6">
          <p className="text-xl lg:text-2xl font-normal leading-relaxed text-gray-200">
            “Connecta makes everything feel seamless — from managing worker rosters and shift check-ins to automated wallet payouts.”
          </p>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="font-bold text-base text-white">Musa Ibrahim</div>
              <div className="text-xs font-medium text-gray-400">Site Director, Apex Workforce</div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-[#121215] border border-gray-800 rounded-3xl p-6 shadow-2xl space-y-5 text-gray-300 font-sans transform rotate-1 scale-95 opacity-90 hover:opacity-100 transition-all">
            <div className="flex items-center justify-between border-b border-gray-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xs text-gray-400 font-medium">👋 Morning, Musa</div>
                  <div className="font-black text-sm text-white">Connecta Overview</div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-[#18181c] p-4 rounded-2xl border border-gray-800">
                <span className="text-[10px] font-bold text-gray-500 uppercase">Monthly Payroll</span>
                <div className="text-2xl font-black text-white mt-1">₦2,650,450</div>
              </div>
              <div className="bg-[#18181c] p-4 rounded-2xl border border-gray-800">
                <span className="text-[10px] font-bold text-gray-500 uppercase">Active Workers</span>
                <div className="text-2xl font-black text-primary mt-1">48 Active</div>
              </div>
            </div>
          </div>
        </div>
