          ...
          <div className="space-y-8">
            ...
            <nav className="space-y-2">
              ...
              <Link
                ...
                className={`flex items-center gap-3.5 px-4 py-3 rounded-2xl font-semibold text-sm transition-all ${
                  location.pathname.includes('/wallet') ? 'bg-white text-gray-900 font-extrabold shadow-xs border border-gray-100' : 'text-gray-500 hover:text-gray-900'
                }`}
              >
                <Wallet className={`w-5 h-5 ${location.pathname.includes('/wallet') ? 'text-emerald-600' : ''}`} />
